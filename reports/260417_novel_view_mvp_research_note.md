...
## 2. The v3 6-View Config (Authoritative from 260306 image)
...
Source: `GoogleDrive:AMILab_my/_Results/FaceLift/260306_2nd_phase/_novel_view_rendering/novel_6view_temporal_v3/novel_6view_grid.png` — image labels directly read.

Note: Current FaceLift `cinematic_sequence.py::_seg_grid_novel_6views` (newer code) uses different elevations [80, 70, 60, -85, -40, -30]. User explicitly referenced v3 (older), so module uses v3.
