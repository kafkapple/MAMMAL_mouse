...
> **F6j 가설 업데이트 (2026-04-17 PM, [belly_deformer_investigation.md](260417_belly_deformer_investigation.md))**: "belly_stretch_deformer 누락으로 belly-dent" 가설은 **bone_length[13] 분포 검사 결과 약화**됨 (0/900 saturation, std 0.22 actively used within [0.5, 1.5]). Upstream MAMMAL도 deformer 없음 — "forgotten feature" 아닌 architectural choice. F6j는 F6a generic의 sub-case로만 유지.
